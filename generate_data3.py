...
def toggle_promotions(user_data):
    if user_data["carrito"]["promociones"]:
...
if __name__ == "__main__":
    ...
    # Seleccionar y duplicar el 40% de los datos, modificando promociones
    repeated_data = random.sample(data_array, num_to_repeat)
    for user in repeated_data:
        toggle_promotions(user)
